...
//    var currentRoomId = "-KBWKykTqc5R3NT4C1qt"  // set Hop-On Hop-Off Bus Tour as default
    ...
    override func viewDidLoad() {
        ...
        navigationItem.rightBarButtonItem = UIBarButtonItem(image: UIImage(named:"solo_user"), style: .Plain, target: self, action: "displayUserInfo")
    ...
    @IBAction func displayUserInfo(sender: UIBarButtonItem){
        navigationController?.pushVC(DetailViewOfChat())
    }
}
